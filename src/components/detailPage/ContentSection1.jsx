...
const contentData = [
  {
    ...
    desc: `"Labrador 스캐너를 이용하여 소프트웨어 소스코드, zip 파일 또는 CLI를 분석한 결과들이 나오는 페이지로, 공통 취약점 등급 시스템인 CVSS의 두 가지 버전과 래브라도만의 등급 시스템인 LPP 총 세 가지 버전에 따라 소프트웨어 명세서인 SBOM, 취약점과 라이선스 수, patch가 필요한 취약점과 조치가 필요한 라이선스의 정보를 한 눈에 확인할 수 있다. 또한 헤더를 통해 다른 프로젝트들과 비교하는 '분석 비교 페이지'로의 이동과 비교 횟수를 확인할 수 있으며 해당 프로젝트에 대한 분서을 여러번 반복할 수 있다."`,
